...
var timer;
var time = 600;
class CircleDetailsPage extends EPage {
  get data() {
    return {
      // videoHidden: true,
      userInfo: {},
    ...
    return {
      ...
      [events.ui.EDITOR]() {
        ...
        if (this.data.model.isOwner == 1) {
          wx.navigateTo({
            url: '../../pages/learningcircle/page/circleEditor/circleEditor?id=' + this.data.model.communityId + '&isOwner=' + this.data.model.isOwner
          })
        } else {
          wx.navigateTo({
            url: '../../pages/learningcircle/page/CircleDetails/CircleDetails?id=' + this.data.model.communityId
          })
        }
      ...
      [events.ui.REPORT_SIGN](e) {
        wx.navigateTo({
          url: '../learningcircle/page/complain/complain?signInId=' + e.currentTarget.dataset.signid
        })
      },
      [events.ui.ZAN](e) {
        let like = e.currentTarget.dataset.like;
      ...
      [events.ui.modalCandel]() {
        ...
        put(effects.JOIN)
        this.$common.showMessage(this, '加入圈子成功');
      },
      ...
      [events.ui.complainCircle]() {
        ...
        wx: wx.navigateTo({
          url: '../learningcircle/page/complain/complain?communityId=' + this.communityId + '&type=circle',
        })
      },
      [events.ui.RESTART](e) {
        this.setData({
      ...
      [events.ui.GOTO_ADDDIARY](e) {
        wx.navigateTo({
          url: '../learningcircle/page/addDiary/addDiary?id=' + this.data.subjectId + '&communityId=' + this.data.model.communityId
        })
      },
      // 删除评论
...
EApp.instance.register({
  type: CircleDetailsPage,
  id: 'CircleDetailsPage',
  config: {
    events,
    effects,
    actions
